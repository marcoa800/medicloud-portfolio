...
const apps = [
  ...
  },
  {
    ...
    category: "Salud",
    tech: ["WebRTC", "Next.js", "PostgreSQL"],
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
                ...
                <div className="p-7 flex-1 flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {app.tech.slice(0, 3).map(t => (
                      <span key={t} className="text-[10px] font-bold bg-slate-50 text-slate-400 border border-slate-100 px-2.5 py-1 rounded-md">
                        {t}
                      </span>
                    ))}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-slate-800/50 p-8 rounded-[2rem] border border-slate-700/50">
            ...
            <p className="text-slate-400 mb-6 text-sm">
              Contáctenos hoy para una consultoría técnica sobre cómo optimizar sus procesos de salud y gestión.
            </p>
            <div className="w-full text-center bg-blue-600 text-white font-bold py-4 rounded-2xl select-all">
              {CONTACT_EMAIL}
            </div>
          </div>
        </div>
      ...
      {showTop && (
        <button
          ...
          className="fixed bottom-8 right-8 z-40 bg-blue-600 text-white p-4 rounded-2xl shadow-lg hover:bg-blue-700 transition-all hover:-translate-y-1"
